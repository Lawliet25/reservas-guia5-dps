...
import Cita from './components/Reserva';
...
const App = () => {
 ...
 // Almacenar las reservas en storageconst guardarCitasStorage = async (citasJSON) => {
 ...
 <Text style={styles.titulo}>Administrador de reservas restaurante</Text>
 <View>
...
const styles = StyleSheet.create({
 ...
 titulo: {
 color: '#FFF',marginTop: Platform.OS === 'ios' ? 40 : 20 ,
 marginBottom: 20,
 fontSize: 24,
 fontWeight: 'bold',
 textAlign: 'center'
